            ...
            <div class="row no-gutter">
                <div class="col-lg-4 col-sm-6">
                    <a href="newsletter" class="portfolio-box">
                        <img src="<c:url value="img/Newsletter.png"/>" class="img-responsive" style="height: 256px; width:256px" alt=""/>
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="gererAnnonceAdmin" class="portfolio-box">
                        <img src="<c:url value="img/Annonce.png"/>" class="img-responsive" alt="" style="height: 256px; width:256px">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                  Annonces  
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="addEvent" class="portfolio-box">
                        <img src="<c:url value="img/Evenement.png"/>" class="img-responsive" style="height: 256px; width:256px" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
            ...
            <div class="row no-gutter">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="stat" class="portfolio-box">
                        <img src="<c:url value="img/Statistiques.png"/>" class="img-responsive" style="height: 256px; width:256px" alt="">
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                   Statistiques 
